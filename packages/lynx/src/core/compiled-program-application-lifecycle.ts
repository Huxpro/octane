...
import { installLynxFirstScreenHost } from './first-screen-host.js';
import { compactLynxLifecycleMessages, snapshotLynxLifecycleData } from './lifecycle-data.js';
...
} from './compiled-program-native-owner-types.js';
import { type LynxContextProxy, type LynxContextProxyEvent } from './protocol.js';
import { localizeLynxHostValue } from './transport-codec.js';
 ...
 */
export function installLynxCompiledProgramApplicationWithNativeOwner(
	input: boolean | InstallLynxCompiledProgramApplicationOptions = false,
	installNativeOwner: InstallLynxCompiledProgramNativeOwner,
	...
	let receiver!: LynxCompiledProgramNativeOwner['receiver'];
	const owner = installNativeOwner({
		target,
		context,
