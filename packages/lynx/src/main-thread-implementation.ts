 ...
 */
export type LynxBackgroundOutboundValidator = (
	value: unknown,
	resolveProgram: typeof residentRunProgram,
) => LynxBackgroundOutboundMessage;
export type LynxBackgroundInboundSelfCheck = (
	message: LynxBackgroundInboundMessage,
) => LynxBackgroundInboundMessage;

export function installLynxMainThreadWithValidator<Node extends LynxElementRef = LynxElementRef>(
	options: InstallLynxMainThreadOptions,
	validateBackgroundOutbound: LynxBackgroundOutboundValidator,
	selfCheckBackgroundInbound: LynxBackgroundInboundSelfCheck,
	...
	const handleCancelMainCall = (
		message: Extract<LynxBackgroundOutboundMessage, { type: 'cancel-main' }>,
	): void => {
	...
	function receive(event: LynxContextProxyEvent): void {
		...
		let message: LynxBackgroundOutboundMessage;
