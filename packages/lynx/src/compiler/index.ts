/**
 * The Lynx compiler backend: the shared program IR and what a build emits into
 ...
 * grows a second file.
 *
 * The derivation reaches into `src/core/` in one place, deliberately.
 * `derive-program.ts` lowers a plan through the renderer's own
 ...
 */
export const signature = 'lynx-main-thread-program/32';
