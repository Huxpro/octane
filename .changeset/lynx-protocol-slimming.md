...
Lynx transport protocol version 2 lets the background derive every
acknowledgement handle delta locally from the batch it sent —
...
without crossing the wire once a first batch has been accepted. The
